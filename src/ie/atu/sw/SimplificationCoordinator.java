...
public class SimplificationCoordinator {
	 ...
	 */
	public SimplificationCoordinator(SimplifierConfig config, List<Map.Entry<String, Boolean>> toSimplifyList) {
		this.config = config;
		this.toSimplifyList = toSimplifyList;
		this.simpProcessor = new SimplificationProcessor(config.vectorSimilarityAlg());
	}
	...
	public void coordinateSimplification(Map<String, double[]> commonEmbedMap, Map<String, double[]> embedMap)
			throws IOException {
